                    ...
                    <div className="text-center py-8 text-gray-500">ไม่มีคิวที่รออยู่</div>
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <div className="text-4xl font-bold text-gray-800" style={{ color: '#044C72' }}>
                            {queue.queueNumber}
                          </div>
              ...
              <div className="p-6">
                {currentCalledQueue ? (
                  ...
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-500 text-lg mb-6">ไม่คิวในขณะนี้ กรุณาเพิ่มคิวปัจจุบัน</p>
                    {nextQueue && (
                      <button
              ...
              <div className="p-6">
                <div className="space-y-3 max-h-[400px] overflow-y-auto">
                  {skippedQueues.length === 0 ? (
                    <div className="text-center py-8 text-gray-500">ไม่มีคิวที่ถูกข้าม</div>
                  ) : (
                    skippedQueues.map((queue) => (
                      <div key={queue.queueId} className="bg-white rounded-3xl px-6 py-4 border-2 border-gray-200 hover:border-red-300 transition-colors shadow-sm">
                        <div className="flex items-center justify-between">
